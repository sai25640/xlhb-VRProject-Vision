...
namespace VRStandardAssets.Utils
{
    ...
    public class SelectionSlider : MonoBehaviour
    {
        ...
        [SerializeField] private float m_GazeDuration = 0.1f;           //UI激活时间
        ...
        {
            yield return new WaitForSeconds(m_GazeDuration);
        ...
        {
            //开启Slider Sprite Swap模式
            if (m_Slider.IsInteractable())
                m_Slider.image.sprite = m_Slider.spriteState.highlightedSprite;
        ...
        private void HandleOut ()
        {
            //开启Slider Sprite Swap模式
            if (m_Slider.IsInteractable())
                m_Slider.image.sprite = m_Slider.spriteState.disabledSprite;
