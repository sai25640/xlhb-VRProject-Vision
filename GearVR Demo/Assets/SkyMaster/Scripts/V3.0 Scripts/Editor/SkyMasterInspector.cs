...
//		public void  OnGUI () {
			...
			//			GameObject MapCenterOBJ = MapCenter as GameObject;
				...
				//		script.SkyManager.SunSystem = SunSystem;
						...
						//ADD CLOUDS
						script.SkyManager.Upper_Dynamic_Cloud = (GameObject)Instantiate(Upper_Dynamic_CloudPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Upper_Dynamic_Cloud.transform.parent = script.transform;
						script.SkyManager.Lower_Dynamic_Cloud = (GameObject)Instantiate(Lower_Dynamic_CloudPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Lower_Dynamic_Cloud.transform.parent = script.transform;
						script.SkyManager.Upper_Cloud_Bed = (GameObject)Instantiate(Upper_Cloud_BedPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);			script.SkyManager.Upper_Cloud_Bed.transform.parent = script.transform;
						script.SkyManager.Lower_Cloud_Bed = (GameObject)Instantiate(Lower_Cloud_BedPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);			script.SkyManager.Lower_Cloud_Bed.transform.parent = script.transform;
						script.SkyManager.Upper_Cloud_Real = (GameObject)Instantiate(Upper_Cloud_RealPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);		script.SkyManager.Upper_Cloud_Real.transform.parent = script.transform;
						script.SkyManager.Lower_Cloud_Real = (GameObject)Instantiate(Lower_Cloud_RealPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);		script.SkyManager.Lower_Cloud_Real.transform.parent = script.transform;
						script.SkyManager.Upper_Static_Cloud = (GameObject)Instantiate(Upper_Static_CloudPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);	script.SkyManager.Upper_Static_Cloud.transform.parent = script.transform;
						script.SkyManager.Lower_Static_Cloud = (GameObject)Instantiate(Lower_Static_CloudPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);	script.SkyManager.Lower_Static_Cloud.transform.parent = script.transform;
						script.SkyManager.Surround_Clouds = (GameObject)Instantiate(Surround_CloudsPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);			script.SkyManager.Surround_Clouds.transform.parent = script.transform;
						script.SkyManager.Surround_Clouds_Heavy = (GameObject)Instantiate(Surround_Clouds_HeavyPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity);	script.SkyManager.Surround_Clouds_Heavy.transform.parent = script.transform;
						...
						script.SkyManager.Sun_Ray_Cloud = (GameObject)Instantiate(Sun_Ray_CloudPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Sun_Ray_Cloud.transform.parent = script.transform;
						script.SkyManager.Cloud_Dome = (GameObject)Instantiate(Cloud_DomePREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); 	script.SkyManager.Cloud_Dome.transform.parent = script.transform;
						script.SkyManager.Star_particles_OBJ = (GameObject)Instantiate(Star_particlesPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Star_particles_OBJ.transform.parent = script.transform;
						script.SkyManager.Star_particles_OBJ.transform.position = script.SkyManager.MapCenter.position;

						script.SkyManager.StarDome = (GameObject)Instantiate(Star_domePREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); 	script.SkyManager.StarDome.transform.parent = script.transform;
						script.SkyManager.CloudDomeL1 = (GameObject)Instantiate(Cloud_Domev22PREFAB1,script.SkyManager.MapCenter.position,Quaternion.identity); 	script.SkyManager.CloudDomeL1.transform.parent = script.transform;
						script.SkyManager.CloudDomeL2 = (GameObject)Instantiate(Cloud_Domev22PREFAB2,script.SkyManager.MapCenter.position,Quaternion.identity); 	script.SkyManager.CloudDomeL2.transform.parent = script.transform;
						...
						//ADD RAIN
						script.SkyManager.SnowStorm_OBJ	=(GameObject)Instantiate(SnowStormPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.SnowStorm_OBJ.transform.parent = script.transform;
						script.SkyManager.Butterfly_OBJ	=(GameObject)Instantiate(ButterflyPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Butterfly_OBJ.transform.parent = script.transform;
						...
						script.SkyManager.Lightning_OBJ	=(GameObject)Instantiate(LightningPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Lightning_OBJ.transform.parent = script.transform;
								
						script.SkyManager.Lightning_System_OBJ	=(GameObject)Instantiate(Lightning_SystemPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Lightning_System_OBJ.transform.parent = script.transform;
						script.SkyManager.VolumeFog_OBJ			=(GameObject)Instantiate(VolumeFogPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.VolumeFog_OBJ.transform.parent = script.transform;
						script.SkyManager.Rain_Heavy			=(GameObject)Instantiate(Rain_Heavy,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Rain_Heavy.transform.parent = script.transform;
						script.SkyManager.Rain_Mild				=(GameObject)Instantiate(Rain_Mild,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Rain_Mild.transform.parent = script.transform;
						script.SkyManager.VolumeRain_Heavy	=(GameObject)Instantiate(VolumeRain_Heavy,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.VolumeRain_Heavy.transform.parent = script.transform;
						script.SkyManager.VolumeRain_Mild	=(GameObject)Instantiate(VolumeRain_Mild,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.VolumeRain_Mild.transform.parent = script.transform;
						...
						script.SkyManager.FallingLeaves_OBJ[0]	=	(GameObject)Instantiate(FallingLeavesPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.FallingLeaves_OBJ[0].transform.parent = script.transform;					
						script.SkyManager.Tornado_OBJs[0]		=	(GameObject)Instantiate(TornadoPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Tornado_OBJs[0].transform.parent = script.transform;				
	//v.3.0.3			script.SkyManager.Butterfly3D_OBJ[0]	=(GameObject)Instantiate(Butterfly3DPREFAB); script.SkyManager.Butterfly3D_OBJ[0].transform.parent = script.transform;						
						script.SkyManager.Volcano_OBJ[0]	=(GameObject)Instantiate(VolcanoPREFAB,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.Volcano_OBJ[0].transform.parent = script.transform;

						script.SkyManager.RefractRain_Mild 	= (GameObject)Instantiate(RefractRain_Mild,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.RefractRain_Mild.transform.parent = script.transform;
						script.SkyManager.RefractRain_Heavy = (GameObject)Instantiate(RefractRain_Heavy,script.SkyManager.MapCenter.position,Quaternion.identity); script.SkyManager.RefractRain_Heavy.transform.parent = script.transform;
...
//				EditorGUILayout.EndHorizontal();
				...
				if(script.SkyManager != null){
					...
					EditorGUILayout.BeginHorizontal();
					script.SkyManager.SPEED = EditorGUILayout.Slider(script.SkyManager.SPEED,0.1f,16,GUILayout.MaxWidth(195.0f));//v3.3 - extend to 16 max
					EditorGUILayout.EndHorizontal();
